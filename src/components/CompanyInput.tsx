          ...
          <form onSubmit={handleSubmit} className="relative">
            <div className="flex items-center gap-3 bg-card rounded-2xl shadow-card border border-border p-2 focus-within:shadow-elevated transition-shadow">
              ...
              <button
                ...
                className="gradient-primary text-primary-foreground px-6 py-3 rounded-xl font-semibold flex items-center gap-2 disabled:opacity-50 hover:opacity-90 transition-opacity"
              >
                {isLoading ? (
                  <>
